...
module ClassPolltionPlainTaintTracking {
...
class SetFlowState extends FlowState {
  ...
  SetFlowState() { this = "Set@" + setOperationType + "-" + setPositionType }

  string toString() {
    result = "Set@" + setOperationType + "-" + setPositionType
  }
...
module TrackingClassPollutionKeyToAssignmentConfiguration implements DataFlow::StateConfigSig {
  ...
  predicate isSink(DataFlow::Node sink, FlowState state) {
    ...
    (
      ...
      state.(SetFlowState).getSetOperationType() = "SetItem" and
      state.(SetFlowState).getSetPositionType() = "Object"
    ) or
    (
