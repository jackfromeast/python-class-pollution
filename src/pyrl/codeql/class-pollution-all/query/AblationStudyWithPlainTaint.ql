 ...
 * @description The query finds all the class polluting assignments flow with plain taint
 * @kind problem
 * @problem.severity warning
 * @security-severity 6.1
 * @sub-severity low
 * @id py/class-polliution/class-pollution-assignment-plain-taint
 * @tags security
 ...
 */
 ...
 import vuln.ClassPolltionPlainTaintTracking::ClassPolltionPlainTaintTracking
