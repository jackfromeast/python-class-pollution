 ...
 * @sub-severity low
 * @id py/class-polliution-external/set-any-get-any-path
 * @tags security
 ...
 */
 ...
 select func, externalInput, sourceParamKeyFlowNode, msg, func, func.toString(), sourceParamKeyNode, sourceParamKeyNode.toString(), sourceParamObjNode, sourceParamObjNode.toString(), setOpPrimdKeyNode, setOpPrimdKeyNode.toString(), getOpNode, getOpNode.toString()