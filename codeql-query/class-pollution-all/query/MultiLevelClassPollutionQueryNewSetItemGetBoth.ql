 ...
 * @sub-severity low
 * @id py/class-polliution/set-item-get-both
 * @tags security
 ...
 */
 ...
 where
  (
    isClassPollutedAssignmentSetItemGetBothStrict(sourceParamKeyNode, sourceParamObjNode, setOpPrimdKeyNode, setOpSecondKeyNode, _, _, vulnType, _, getAttrOpNode, getItemOpNode)
  ) and
