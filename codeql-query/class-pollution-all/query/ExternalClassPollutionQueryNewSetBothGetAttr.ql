 ...
 * @sub-severity low
 * @id py/class-polliution-external/set-both-get-attr
 * @tags security
 ...
 */
 ...
 where
  (
    isClassPollutedAssignmentSetBothGetAttrStrict(sourceParamKeyNode, sourceParamObjNode, setOpPrimdKeyNode, setOpSecondKeyNode, _, _, vulnType, _, getOpNode) and
