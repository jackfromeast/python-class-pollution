 ...
 * @sub-severity low
 * @id py/class-polliution-external/set-item-get-attr
 * @tags security
 ...
 */
 ...
 where
  ( 
    isClassPollutedAssignmentSetItemGetAttrStrict(sourceParamKeyNode, sourceParamObjNode, setOpPrimdKeyNode, setOpSecondKeyNode, _, _, vulnType, _, getOpNode) and
