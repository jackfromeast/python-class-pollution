...
| [django-unicorn](https://github.com/jackfromeast/python-class-pollution/blob/main/class-pollution/django-unicorn/README.md) | App | 2.4K | N/A | ```django_unicorn.views.action_parsers.utils.set_property_value(unicornViewObj, '__init__.__globals__["__name__"]', 'polluted')``` | Remote | Zhong | Pending | N/A |
...
| [pokitoki](https://github.com/jackfromeast/python-class-pollution/blob/main/class-pollution/pokitoki/README.md) | App | 315 | N/A | ```bot.config.ConfigEditor.set_value("openai.__init__.__globals__.__name__", "polluted")``` | Func | Zhong | Pending | N/A |
