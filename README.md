...
|:-------:|:-----:|:-------:|----------|:--------:|:------:|:---:|
| [deepdiff](https://github.com/jackfromeast/python-class-pollution/class-pollution/deepdiff.md) | 2K | v8.0.0 | ```{"attribute_added" {"root['x']"namedtuple, "root['x'].'__globals__'['_sys'].'__name__'""polluted"}}``` | chilaxan | Accepted | CVE-2024-5254 |
